# This non-secret fixture adapts the Sprint 5 dev network values for a module CI
# plan. Jenkins supplies AWS credentials at runtime; no resources are applied.
...
network_acls = {
  public = {
    ...
    ingress = [
      ...
      { rule_number = 140, protocol = "6", rule_action = "allow", cidr_block = "0.0.0.0/0", from_port = 22, to_port = 22 }
    ]
    egress = [
